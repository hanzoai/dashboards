...
require (
	...
	github.com/getkin/kin-openapi v0.136.0 // @grafana/grafana-app-platform-squad
	...
	github.com/grafana/grafana-plugin-sdk-go v0.292.1 // @grafana/plugins-platform-backend
