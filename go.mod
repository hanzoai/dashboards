...
require (
	buf.build/gen/go/parca-dev/parca/connectrpc/go v1.20.0-20260523035409-ca8a9e862107.1 // @grafana/observability-traces-and-profiling
	buf.build/gen/go/parca-dev/parca/protocolbuffers/go v1.36.11-20260523035409-ca8a9e862107.1 // @grafana/observability-traces-and-profiling
	cloud.google.com/go/kms v1.31.0 // @grafana/grafana-backend-group
	cloud.google.com/go/storage v1.61.3 // @grafana/grafana-backend-group
	...
	github.com/aws/aws-sdk-go-v2 v1.41.11 // @grafana/aws-datasources
	github.com/aws/aws-sdk-go-v2/credentials v1.19.21 // @grafana/grafana-operator-experience-squad
	github.com/aws/aws-sdk-go-v2/service/cloudwatch v1.58.1 // @grafana/aws-datasources
	github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs v1.75.0 // @grafana/aws-datasources
	github.com/aws/aws-sdk-go-v2/service/ec2 v1.305.1 // @grafana/aws-datasources
	github.com/aws/aws-sdk-go-v2/service/oam v1.24.4 // @grafana/aws-datasources
	github.com/aws/aws-sdk-go-v2/service/resourcegroupstaggingapi v1.33.1 // @grafana/aws-datasources
	...
	github.com/aws/smithy-go v1.27.0 // @grafana/aws-datasources
	...
	github.com/grafana/authlib/types v0.0.0-20260304161757-e152786a5bb4 // @grafana/identity-access-team
	...
	github.com/grafana/grafana-aws-sdk v1.4.5 // @grafana/aws-datasources
	...
	github.com/grafana/grafana-plugin-sdk-go v0.291.1 // @grafana/plugins-platform-backend
	...
	github.com/phpdave11/gofpdi v1.0.16 // @grafana/sharing-squad
	...
	google.golang.org/api v0.274.0 // @grafana/grafana-backend-group
